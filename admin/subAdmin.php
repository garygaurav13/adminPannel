          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <a href="createSubAdmin.php" class="btn btn-primary" style="float: right; font-size: 19px; font-weight: 700;">Create</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                            ...
                            <td>
                              <ul style="display: flex;list-style: none;">
                                ...
                                <form action="code.php" method="post">
                                    ...
                                    <button type="submit" class="btn btn-dnager" name="delete_subAdmin"><i class="fa fa-trash" style="font-size:24px;color:red;"></i></button>
                                </form>
                              </ul>
                            </td>
                          </tr>
